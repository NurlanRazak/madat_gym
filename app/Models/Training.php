...
class Training extends Model
{
    ...
    */
    ...
    protected $fillable = ['name', 'day_number', 'approaches_number', 'repetitions_number', 'weight', 'exercise_id', 'programtraining_id', 'user_id', 'hour_start', 'hour_finish', 'lead_time', 'active'];
    // protected $hidden = [];
    // protected $dates = [];

          ...
          <div class="header-part-right">
              ...
              <div class="dropdown">
                  <div  class="user col align-self-end">
                      <img src="{{ $user->image ? asset('uploads/'.$user->image) : asset('assets/images/no-image.png') }}" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
